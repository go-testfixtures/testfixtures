...
BEGIN
    ...
    SELECT COUNT(*) INTO c FROM user_tables WHERE table_name = 'FAVORITES';
    IF c = 1 THEN
        EXECUTE IMMEDIATE 'DROP TABLE FAVORITES';
    END IF;
    ...
    SELECT COUNT(*) INTO c FROM all_sequences WHERE sequence_name = 'FAVORITES_SEQ';
    IF c = 1 THEN
        EXECUTE IMMEDIATE 'DROP SEQUENCE FAVORITES_SEQ';
    END IF;
    ...
    EXECUTE IMMEDIATE 'CREATE SEQUENCE favorites_seq';
